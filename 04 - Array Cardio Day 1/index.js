...
console.log(inventorByBirthYear);
...
const instancesOfData = data.reduce(
  (instances, item) => {
    const updatedInstances = instances;
    const numInstance = updatedInstances[item] + 1;
    updatedInstances[item] = numInstance;
